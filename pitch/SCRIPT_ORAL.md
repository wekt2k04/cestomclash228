# Script oral — CestomClash228 (concours CréaAfrica)

Ce document accompagne `CestomClash228-Pitch.pptx` : pour chaque slide, ce qu'il faut **dire**
(texte suggéré, à adapter à ta voix — pas à réciter mot pour mot), ce qu'il faut **faire
...
**Repère :** ne pas s'attarder sur le titre à l'écran — le public le lit pendant que tu parles.
...
`docs/CONCOURS.md` note la **Posture du candidat** comme critère important, et la **Tenue
vestimentaire** comme critère à part entière. Rappels pratiques, pas de contenu à apprendre :
